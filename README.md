...
local DISCORD_LINK = "https://discord.gg/VBazV4q72B"
...
local VIP_GAME_SCRIPTS = {
    -- [99001115434148] = { "https://raw.githubusercontent.com/username/repo/branch/vip_america.lua" },
}
...
-- Cores (all-black com tons de cinza para contraste - "cinzas" para melhor leitura)
-- Ajustei para tons de cinza para facilitar detecção de texto/frames e evitar interface totalmente preta.
local COLOR_BG      = Color3.fromRGB(10, 10, 12)   -- fundo principal (muito escuro, mas não preto absoluto)
local COLOR_PANEL   = Color3.fromRGB(22, 22, 24)   -- painéis (leves cinzas)
local COLOR_GLASS   = Color3.fromRGB(30, 30, 34)   -- painel "glass"
local COLOR_ACCENT  = Color3.fromRGB(140, 140, 140) -- acento neutro (cinza claro) para elementos detectáveis
local COLOR_TEXT    = Color3.fromRGB(245, 245, 245) -- texto principal (quase branco)
local COLOR_SUB     = Color3.fromRGB(170, 170, 175) -- texto secundário (cinza claro)
...
-- asset trocado para o fornecido (IMG1715)
bgImage.Image = "rbxassetid://71574024605218"
...
local stroke = Instance.new("UIStroke", panel); stroke.Color = COLOR_ACCENT; stroke.Thickness = 2; stroke.Transparency = 0.6
...
-- asset trocado para o fornecido (IMG1715)
icon.Image = "rbxassetid://71574024605218"
...
label.TextSize = TOUCH_ENABLED and 34 or 40
-- Texto principal trocado para "011"
label.Text = "011"
...
inputWrap.BackgroundColor3 = COLOR_PANEL
inputWrap.ZIndex = 13
...
inputIcon.ImageColor3 = COLOR_SUB
...
enterBtn.TextColor3 = COLOR_TEXT
...
getKeyBtn.BackgroundColor3 = COLOR_PANEL
...
progBG.BackgroundColor3 = COLOR_PANEL
...
local function playVipVideoThen(callback)
    pcall(function()
        ...
        skipBtn.BackgroundColor3 = COLOR_PANEL
...
local function setVipVisual(enabled)
    pcall(function()
        if enabled then
            ...
            label.TextColor3 = prevLabelColor or COLOR_TEXT
